...
const testScenarios = [
  {
    name: "Simple SSR",
    path: "/test/simple",
    description: "Baseline React component rendering with minimal complexity",
    complexity: "Low",
    apiCalls: 0,
...
export function renderHomePage(data: any, ctx: any): string {
  const content = (
    <Layout title="Node.js React SSR Experiment">
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
        <div className="container mx-auto max-w-6xl px-4 py-12">
          <header className="mb-12 text-center">
            <h1 className="mb-4 text-5xl font-bold text-gray-900">
              Node.js React SSR <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Worker Experiment</span>
            </h1>
            ...
            <div className="flex justify-center gap-4">
              ...
              <div className="rounded-lg bg-white px-4 py-2 shadow">
                ...
                <span className="ml-2 text-lg font-bold text-purple-600">Node.js + React</span>
              </div>
            </div>
          </header>
          ...
          <div className="mb-8 rounded-xl bg-white p-8 shadow-lg">
            ...
            <div className="prose prose-blue max-w-none">
              <p className="text-gray-700">
                ...
                for server-side rendering with React. Inspired by Wix
                ...
                with vanilla Node.js + React SSR.
              </p>
